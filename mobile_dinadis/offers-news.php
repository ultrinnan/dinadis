...
<div id="myCarousel" class="carousel slide top_slider" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
		...
		?>
		<div class="item active" style="background: url(<?php echo esc_url(get_template_directory_uri());?>/images/news1.jpg) no-repeat center;background-size:cover;">
			<div class="content">
...
<div class="content">
	<div class="box">
		...
		$wp_query->query('category_name=offers&showposts=3');
		$cat_name = single_cat_title('', false);
		echo '<div class="title">' . $cat_name . '</div>';
	...
	<a class="more" href="/offers"><?=get_option('more_offers');?></a>
</div>

<div class="parallax_box" style="background: url(<?php echo esc_url(get_template_directory_uri());?>/images/news2.jpeg) no-repeat center; background-size:cover;">
	</div>
...
<div class="content">
	<div class="box">
		<?php
		$wp_query = new WP_Query();
		$wp_query->query('category_name=news&showposts=3');
		$cat_name = single_cat_title('', false);
		echo '<div class="title">' . $cat_name . '</div>';
	...
	<a class="more" href="/news"><?=get_option('more_news');?></a>
</div>
