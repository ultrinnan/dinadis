...
<div class="totop-btn hide">
	<i class="fa fa-arrow-up totop-btn-arrow" aria-hidden="true"></i>
</div>
	...
	<script src="<?php echo esc_url(get_template_directory_uri());?>/js/preloader.js"></script>
