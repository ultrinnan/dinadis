...
function language_options_content(){
	...
	if ($_POST) {
		...
		update_option('tickets', $_POST['tickets']);
		update_option('tickets_air', $_POST['tickets_air']);
		update_option('tickets_rw', $_POST['tickets_rw']);
		...
		update_option('portfolio_main', $_POST['portfolio_main']);
		// var_dump($result);
	}
	...
	$tickets_air = get_option('tickets_air');
	$tickets_rw = get_option('tickets_rw');
	...
	$portfolio_main = get_option('portfolio_main');
	...
	?>
		...
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="tickets" name="tickets" value="<?=$tickets;?>">
				
				<label for="tickets_air">На самолет:</label>
				<input type="text" class="form-control" id="tickets_air" name="tickets_air" value="<?=$tickets_air;?>">
				
				<label for="tickets_rw">На поезд:</label>
				<input type="text" class="form-control" id="tickets_rw" name="tickets_rw" value="<?=$tickets_rw;?>">
			...
			<div class="form-group">
				...
				<label for="portfolio_main">Портфолио:</label>
				<input type="text" class="form-control" id="portfolio_main" name="portfolio_main" value="<?=$portfolio_main;?>">
