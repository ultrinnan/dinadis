...
<div id="myCarousel" class="carousel slide top_slider" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active" style="background: url(<?php echo esc_url(get_template_directory_uri());?>/images/exib3.jpg) no-repeat center;background-size:cover;">
			<div class="content">
...
<div class="pagination">
    ...
    echo paginate_links( array(
        ...
        'prev_text'    => __('<i class="fa fa-angle-left pag-next-prev-btn"></i>'),
        'next_text'    => __('<i class="fa fa-angle-right pag-next-prev-btn"></i>')
    ) );
    ?>
</div>
